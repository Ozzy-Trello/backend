...
export class Config {
	...
	public static readonly REST_SECRET_KEY: string = process.env.REST_SECRET_KEY || "";
	public static readonly REST_REFRESH_KEY: string = process.env.REST_REFRESH_KEY || "";
	...
	static {
		...
		if (!this.REST_SECRET_KEY || !this.REST_REFRESH_KEY) {
			throw new Error("You need to `REST_SECRET_KEY` and `REST_REFRESH_KEY` environment variables");
		}
	}
}
