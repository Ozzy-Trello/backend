...
export interface AccessControlControllerI {
  CreateAccessControl(
    user_id: string,
    data: AccessControlCreateData
  ): Promise<ResponseData<CreateAccessControlResponse>>;
  GetAccessControl(
    filter: AccessControlFilter
  ): Promise<ResponseData<AccessControlResponse>>;
  GetAccessControlList(
    filter: AccessControlFilter,
    paginate: Paginate
  ): Promise<ResponseListData<Array<AccessControlResponse>>>;
...
export function fromRoleDetailToAccessControlResponse(
  data: RoleDetail
...
export function fromRoleDetailToAccessControlResponseList(
  data: Array<RoleDetail>
): Array<AccessControlResponse> {
